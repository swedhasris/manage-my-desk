...
export function Settings() {
 ...
 <span className="text-[10px] font-semibold uppercase tracking-[0.4em]">Master Infrastructure</span>
 </div>
 {isAdmin && (
 <Button
 ...
 variant="outline"
 size="sm"
 className="h-8 border-sn-green/20 text-sn-green hover:bg-sn-green/10 text-[10px] font-semibold uppercase tracking-widest px-4 rounded-xl"
 >
 <Sparkles size={12} className="mr-2" /> Seed Demo Data
 </Button>
 )}
 </div>
 <h1 className="text-6xl font-semibold text-foreground tracking-tighter">Platform Architect</h1>
 ...
 className={cn(
"flex items-center gap-2.5 px-6 py-3 rounded-[18px] text-sm font-semibold transition-all duration-500",
 ...
 <tr>
 <th className="px-8 py-5 text-[10px] font-semibold uppercase tracking-widest text-muted-foreground">Timestamp</th>
 <th className="px-8 py-5 text-[10px] font-semibold uppercase tracking-widest text-muted-foreground">Admin</th>
 <th className="px-8 py-5 text-[10px] font-semibold uppercase tracking-widest text-muted-foreground">Module</th>
 <th className="px-8 py-5 text-[10px] font-semibold uppercase tracking-widest text-muted-foreground">Action</th>
 <th className="px-8 py-5 text-[10px] font-semibold uppercase tracking-widest text-muted-foreground">Summary</th>
 </tr>
 </thead>
 ...
 <div className="w-6 h-6 rounded-full bg-sn-green/20 flex items-center justify-center text-[10px] font-semibold text-sn-green">
 {log.performedBy[0].toUpperCase()}
 </div>
 <div className="text-xs font-semibold">{log.performedBy}</div>
 </div>
 </td>
 <td className="px-8 py-5">
 ...
 <td className="px-8 py-5">
 <span className={cn(
"px-3 py-1 rounded-lg text-[9px] font-semibold uppercase",
 ...
 <span className="text-xs font-semibold uppercase tracking-[0.2em]">Add New Workflow</span>
 </button>
 </div>
 </div>
 )}
 ...
 <h2 className="text-4xl font-semibold">Global System Settings</h2>
 ...
 <h3 className="text-xl font-semibold text-sn-dark dark:text-white">Email Notification CC</h3>
 </div>
 ...
 <label className="text-[10px] font-semibold uppercase tracking-widest text-muted-foreground ml-1">CC Email Recipients</label>
 <input 
 type="text"
 ...
 <div className="text-sm font-semibold text-red-500">Maintenance Mode</div>
 ...
 className={cn(
"fixed bottom-8 right-8 px-8 py-4 rounded-[20px] shadow-2xl flex items-center gap-3 z-50 backdrop-blur-xl border font-semibold text-sm",
 ...
 <h3 className="text-2xl font-semibold">{editingItem.data.id ? 'Edit' : 'Create'} {editingItem.type}</h3>
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-semibold uppercase tracking-widest text-muted-foreground ml-1">Workflow Icon / Graphic</label>
 <div className="flex items-center gap-4">
 ...
 className="w-full text-[10px] file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-[10px] file:font-semibold file:bg-sn-green file:text-sn-dark hover:file:bg-sn-green/80 cursor-pointer"
 />
 </div>
 ...
 <Button type="button" variant="outline" onClick={() => setIsModalOpen(false)} className="flex-1 rounded-2xl py-6 font-semibold uppercase tracking-widest text-[10px]">Cancel</Button>
 <Button type="submit" disabled={loading} className="flex-1 bg-sn-green text-sn-dark rounded-2xl py-6 font-semibold uppercase tracking-widest text-[10px]">
...
"w-full flex items-center justify-between p-4 rounded-2xl group transition-all duration-500 border relative overflow-hidden cursor-pointer",
 ...
 <div className="text-left">
 <div className={cn("text-sm font-semibold transition-colors", selectedId === item.id ?"text-sn-green" :"text-sn-dark dark:text-gray-200")}>
 {item.name}
 </div>
 {item.providerName && <div className="text-[9px] font-bold text-muted-foreground uppercase">{item.providerName}</div>}
 {item.sla && <div className="text-[9px] font-semibold text-sn-green uppercase">{item.sla} SLA</div>}
 </div>
 </div>
 ...
 className="w-full bg-muted/40 text-muted-foreground/40 h-12 rounded-xl flex items-center justify-center gap-2 font-semibold text-[10px] uppercase tracking-widest cursor-not-allowed border border-dashed border-muted-foreground/20 select-none"
 >
