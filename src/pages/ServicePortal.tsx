...
export function ServicePortal() {
  ...
  return (
    <div className="space-y-12 max-w-6xl mx-auto pb-20 font-outfit">
      ...
      <div className="text-center space-y-6 py-16 relative bg-sn-sidebar/30 rounded-[40px] border border-white/5 overflow-hidden">
        ...
        <p className="text-xs font-black uppercase tracking-[0.4em] text-sn-green">Unified End-User Self-Service Portal</p>
        ...
        {PORTAL_ACTIONS.map((action) => (
          ...
          >
            ...
            <div className="space-y-1.5">
              <h3 className="font-black text-sm text-foreground">{action.title}</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <Button variant="ghost" size="sm" className="text-sn-green font-black uppercase text-[10px] tracking-wider" onClick={() => navigate("/tickets")}>
              ...
              activeTickets.slice(0, 5).map((ticket) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="text-sm font-black text-foreground group-hover:text-sn-green transition-colors">{ticket.title}</div>
                      <div className="text-[10px] font-mono font-bold text-muted-foreground mt-0.5">
                        {ticket.number} • Updated {ticket.updatedAt?.toDate ? new Date(ticket.updatedAt.toDate()).toLocaleDateString() : "Just now"}
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="px-2 py-0.5 rounded bg-blue-500/10 text-blue-400 border border-blue-500/20 text-[9px] font-black uppercase tracking-wider">
                      {ticket.status}
                    </span>
        ...
        <div className="space-y-6">
          ...
          {showPreferences ? (
            <div className="bg-sn-sidebar/40 border border-white/10 p-6 rounded-3xl space-y-4 animate-in fade-in slide-in-from-top-4 duration-200">
              <h3 className="text-xs font-black uppercase tracking-wider text-sn-green">Portal Preferences</h3>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1 pt-2">
                  <label className="text-[9px] font-black uppercase text-muted-foreground">Notification CC emails</label>
                  <input
                    type="text"
              ...
              <Button
                ...
                className="w-full bg-sn-green text-sn-dark font-black text-xs uppercase tracking-wider py-2.5 rounded-xl h-auto"
              >
                Save Preferences
              </Button>
          ...
          <div className="bg-sn-sidebar text-white p-6 rounded-3xl space-y-4 relative overflow-hidden border border-white/5 shadow-2xl">
            ...
            <h3 className="font-black text-sm relative z-10">Need technical support?</h3>
            ...
            <Button onClick={() => navigate("/tickets?action=new")} className="w-full bg-sn-green text-sn-dark font-black text-xs uppercase tracking-widest py-3.5 h-auto rounded-2xl relative z-10 shadow-lg shadow-sn-green/20">
              Orchestrate Request
            </Button>
          </div>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
          <div className="bg-sn-sidebar border border-white/10 rounded-[32px] w-full max-w-2xl overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="p-6 border-b border-white/5 bg-black/20 flex items-center justify-between">
              <div>
                <span className="font-mono text-[10px] font-black uppercase tracking-wider bg-blue-500/10 text-blue-400 border border-blue-500/20 px-2 py-0.5 rounded">
                  {selectedTicket.number}
                </span>
                <h3 className="text-lg font-black text-foreground mt-2">{selectedTicket.title}</h3>
              </div>
              <button
            ...
            <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto custom-scrollbar">
              ...
              <div className="grid grid-cols-2 gap-4 bg-black/20 p-4 rounded-2xl border border-white/5 text-xs">
                <div>
                  ...
                  <span className="ml-2 px-2 py-0.5 rounded bg-blue-500/10 text-blue-400 border border-blue-500/20 text-[9px] font-black uppercase tracking-wide">
              ...
              <div className="space-y-2">
                <h4 className="text-xs font-black uppercase text-muted-foreground">Incident Description</h4>
              ...
              {/* Comment Log Stream */}
              <div className="space-y-3">
                <h4 className="text-xs font-black uppercase text-muted-foreground">Incident Log & Conversation</h4>
                  ...
                  {(!selectedTicket.history || selectedTicket.history.length === 0) ? (
                    ...
                    selectedTicket.history.map((hist: any, idx: number) => (
                      <div key={idx} className="p-3 bg-black/10 rounded-xl border border-white/5 space-y-1">
                        <div className="flex justify-between text-[9px] font-black uppercase text-sn-green">
