...
export function CustomizableDashboard({ data, userUid, role, validBreaches }: CustomizableDashboardProps) {
  ...
  return (
    <div className="space-y-6">
          ...
          {isEditing ? (
            <>
              <Button
                ...
                disabled={loading}
                className="bg-sn-green text-sn-dark hover:bg-sn-green/90 text-[10px] font-black uppercase tracking-widest px-4 h-9 rounded-xl"
              >
              ...
              {isAdmin && (
                <Button
                  ...
                  disabled={loading}
                  className="bg-purple-600 hover:bg-purple-700 text-white text-[10px] font-black uppercase tracking-widest px-4 h-9 rounded-xl"
                >
              ...
              <Button
                ...
                disabled={loading}
                variant="outline"
                className="border-red-500/20 text-red-500 hover:bg-red-500/10 text-[10px] font-black uppercase tracking-widest px-4 h-9 rounded-xl"
              >
              ...
              <Button
                ...
                variant="outline"
                className="border-white/10 text-text-dim hover:text-foreground text-[10px] font-black uppercase tracking-widest px-4 h-9 rounded-xl"
              >
                Cancel
              </Button>
            </>
            ...
            <Button
              ...
              variant="outline"
              className="border-sn-green/20 text-sn-green hover:bg-sn-green/10 text-[10px] font-black uppercase tracking-widest px-4 h-9 rounded-xl"
            >
            ...
            >
              ...
              {isEditing && (
                <div className="absolute top-4 right-4 z-40 bg-black/80 backdrop-blur-md rounded-xl p-1 border border-white/10 flex items-center gap-1 shadow-lg opacity-80 hover:opacity-100 transition-opacity">
                  <span className="text-[9px] font-black text-muted-foreground uppercase px-2">{widgetName}</span>
                  <button
                    disabled={index === 0}
        ...
        <div className="p-6 bg-sn-sidebar/35 border border-white/5 rounded-3xl space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
            {inactiveWidgets.map((widgetName) => (
              ...
              >
                <span className="text-[11px] font-black text-text-dim group-hover:text-foreground">{widgetName}</span>
      ...
      {message && (
        <div
          className={`fixed bottom-8 right-8 px-6 py-3.5 rounded-2xl shadow-2xl flex items-center gap-2 z-50 backdrop-blur-xl border text-xs font-black ${
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
          <div className="w-full max-w-md bg-sn-sidebar border border-white/10 rounded-[32px] shadow-2xl p-8 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Assign to User Role</label>
                <select
                  value={templateRole}
              ...
              <div className="flex items-center justify-between p-3 bg-black/20 rounded-xl">
                <div>
                  <div className="text-xs font-black">Lock Layout Configuration</div>
            ...
            <div className="flex justify-end gap-2.5 pt-4">
              <Button
                ...
                className="border-white/5 text-text-dim hover:text-foreground text-[10px] font-black uppercase px-4 h-9 rounded-xl"
              >
                Cancel
              </Button>
              <Button
                onClick={handleSaveTemplate}
                className="bg-purple-600 hover:bg-purple-700 text-white text-[10px] font-black uppercase px-4 h-9 rounded-xl"
              >
                Save Template
              </Button>
            </div>
